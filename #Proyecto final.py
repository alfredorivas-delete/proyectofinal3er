#Proyecto final 
#Submodulo
#Autores: Rivas Lerma Alfredo Nicolas y Orona Hernandez Diego
...
def abrir_acerca_de():
    ...
    acerca.geometry("500x400")

    lbl_id = tk.Label(acerca, text="Software POS Sneacker's Club 2025", font=("Arial", 14))
    lbl_id.pack(pady=5)

    lbl_creado = tk.Label(acerca,
                          text="Creado por: Alfredo Nicolas Rivas Lerma y Orona Hernandez Diego",
                          font=("Arial", 12))
...
try:
    ...
    lbl_sin_logo = tk.Label(ventana, text="(Aquí va el logo)", font=("Arial", 14),
                            bg="#f30b0b", fg="white")
